...
#| tbl-cap: "Antall troverdige kjøretøylengder i Kjøretøyregisteret."
...
n_vehicles  |> 
  ...
  flextable::set_header_labels(
    class = "Kjøretøy\n-gruppe",
    valid_length_TRUE = "Troverdig\nlengde",
    valid_length_FALSE = "Feil\nlengde"
  ) |> 
  flextable::bold(part = "header") |> 
  flextable::bg(bg = "#ED9300", part = "header")
```

I @fig-plot_length_distributions og @tbl-autosys_length vises fordeling av lengder per kjøretøygruppe.
...
#| fig-height: 6
#| fig-cap: "Fordeling av Kjøretøyregisterets tillatte totalvekter per kjøretøyklasse"
