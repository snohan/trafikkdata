...
Brekktunnelen (tunnel)
Garli (sentrisk)
Berkåk januar 2020 (grei flyt?) 8.1 emu 16.1 lm
Krokstadøra N (?)
...
Sammenligning av andel tunge kjøretøy før og etter bytte av datalogger på Berkåk. For EMU3 er data hentet fra 6. - 8. januar 2020 og for LM er det 20. - 22. januar 2020.

```{r berkaak_heavy_ratio, fig.height=4, fig.width=8}
berkaak_hr %>% 
  dplyr::rename(lane_number = lane) %>% 
  plot_heavy_ratio()
```

Siden data er fra ulike uker, kan andel tunge avvike noe. Men her er det rimelig likt nivå disse tre dagene.




Sammenlign andel tunge før og etter 
Sammenlign lengdefordeling med andre punkter i nærheten
