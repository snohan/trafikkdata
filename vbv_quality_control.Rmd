...
Her kommer en oppsummering av analysene og forslag til endring av kvalitetskontrollene.
...
Kontrollene som gjelder uansett dataloggertype, bør justeres til følgende (endringer er angitt):
  ...
  - **Klassifisering er ugyldig dersom**:
    - Klassifiseringen mangler. *(Klasse 10 flyttes til LM-kontrollene)*
...
Forslag til nytt kontrollsett:
  ...
  - **Klassifisering er ugyldig dersom**:
    - Klassen er ulik LMV1, LMV2, HMV, LMV2+WC, HMV+WC. *(lagt til)* 
