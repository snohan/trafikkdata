---
title: "Redusert kapasitet på utvalgte vegstrekninger"
format: 
  html:
    css: svv.css
...
# Ev 6 Nordlandsporten, Grane
Trafikkregistreringspunktet Nordlandsporten ligger på Ev 19. Et foto som viser vegen der sensorene er installert vises i @fig-nordlandsporten.

![Ev 6 Nordlandsporten, Gran. Foto: Vegbilder, Statens vegvesen.](congestion_data/nordlandsporten.png){#fig-nordlandsporten width=100%}

I denne analysen er det benyttet data for perioden januar - november 2022.

Nedenfor vises sammenhengen mellom fart og trafikkstrøm.

```{r}
#| label: fig-sf_nordlandsporten
...
Som @fig-speed_day_radhus viser, er det et tydelig avgrenset ettermiddagsrush i felt 3. I felt 4 er det på dagtid noen intervaller innimellom som har redusert kapasitet, men det er også mange intervaller som har lav gjennomsnittsfart samtidig som kapasiteten er god.
