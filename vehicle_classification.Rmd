...
# Bakgrunn
Kjøretøyregisteret er et åpent datasett, og i denne analysen er det sett på kjøretøylengde og klassifisering. Kjøretøy kan klassifiseres etter ulike parametre. I Kjøretøyforskriften benyttes oftest tillatt totalvekt, der det vanligste skillet er 3,5 tonn (skillet mellom lett og tung).
...
Et spørsmål er hvorvidt det er god sammenheng mellom en lengdegrense på 5,6 m og skillet mellom lett og tung på 3,5 tonn tillatt totalvekt.


## Datagrunnlag
Datagrunnlaget i denne analysen er alle kjøretøy som fortsatt er registrerte (ikke avskiltet eller vraket) og første gang registrert etter 1.1.2000 (gamle kjøretøy utgjør liten andel av kjørte kilometer). Videre er utvalget begrenset til følgende kjøretøygrupper:
...
Utvalget inkluderer også de såkalte terrenggående kjøretøyene i de samme kategoriene, f.eks. M1G. En ganske vanlig personbil som Toyota Land Cruiser er blant disse.


# Analyse
Ser på sammenhengen mellom lengde og tillatt totalvekt for ulike valg av lengdegrensen.
...
I byområder er det høy andel varebiler. En stor andel av disse er definert som lette (tillatt totalvekt på akkurat 3,5 tonn), men er betydelig lenger enn 5,6 m, typisk 6,0-7,5 m. Disse vil bli lengdeklassifisert over 5,6 m og føre til en for høy andel tunge.
