...
De to siste kolonnene i tabellen over angir om det er en entydig sammenheng mellom klassene. For nivå 2 er det en helt entydig sammenheng med klassene som trafikkregistreringsutstyret gir.
...
Forskjellen fra nivå 3 er at lett og tung buss er skilt ut som egne klasser med og uten henger. Det er kun Lm som har egen klasse for buss uten henger. Andel tunge busser med henger vil være fåtallig slik at disse kan inngå i klassen for buss. En tilpasning av nivå 4 der utvidelsen fra nivå 3 kun er en egen klasse for tunge busser vil passe utstyret best.
...
Utvidelsen fra nivå 4 til nivå 5 består av at de tunge deles inn i egne klasser for lastebil og trekkbil med og uten henger, samt en for øvrige tunge kjøretøy. Denne utvidelsen har ingen tilsvarende klasser fra EMU3, men LM har egne klasser for lastebil med henger og trekkbil med semitrailer.
