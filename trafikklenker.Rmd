...
#geopackage_file <- "trafikklenker_20200819125511.gpkg"
geopackage_file <- "trafikklenker_20200915130130.gpkg"
...
# Query selected links based on start_node_id 1849767
#link_query <- "SELECT * FROM \"TrafikkLenker\" WHERE start_node_oid IN(90874, 2701394, 3112280)"
# Query selected links
link_query <- "SELECT * FROM \"TrafikkLenker\" WHERE feature_oid IN('ef41fb3a-8b86-4e4a-a8a7-ec7ac6667345')"
...
```{r stedfesting}
query_stedfesting <- "SELECT * FROM \"Trafikklenker_stedfesting\" WHERE element_id IN(1818969)"
query_stedfesting <- "SELECT * FROM \"Trafikklenker_stedfesting\" WHERE feature_oid IN('ef41fb3a-8b86-4e4a-a8a7-ec7ac6667345')"
